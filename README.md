...
-Встановіть правильний тип useRef. 

-Посилання endContentRef використовується для div, який міститься в кінці вмісту.
...
Ваше завдання 
-додати типи для наступних елементів коду:
...
Ви створюєте компонент форми у React. Ви маєте поле введення, в якому ви хочете відстежити зміни. Для цього ви використовуєте обробник подій onChange.  -->
